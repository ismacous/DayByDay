...
object CoachMessages {
    ...
    private val messages: Map<CoachRule, List<String>> = mapOf(
        ...
        CoachRule.DAY_COMPLETE to listOf(
            "Toutes tes cartes sont validées, la journée est bouclée. Bravo, tu es allé au bout !",
            ...
            "Et voilà, toute la journée est validée. Bravo, rien ne traîne derrière toi !",
            ...
            "Tout est validé pour aujourd'hui. Bravo, tu peux souffler l'esprit tranquille !",
            ...
            "Toutes tes cartes sont validées. Continue comme ça, dans six mois tu verras la différence !",
            "Journée entièrement validée. Tu construis quelque chose de solide, jour après jour !",
            ...
            "Chaque carte est validée. Belle rigueur — ta journée est nickel !",
